...
class RangeEntity(Entity):
		...
		def timerFiredAction(self,data):
				...
				for bullet in self.bullets:
						bullet.move(data)
						if bullet.x>data.width-data.margin-self.radius-self.speed*1.5 or bullet.x<data.margin+self.radius+self.speed*1.5 or bullet.y>data.height-data.margin-self.radius-self.speed*1.5 or bullet.y<data.margin+self.radius+self.speed*1.5:
